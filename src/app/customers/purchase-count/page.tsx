...
const items = [
  { name: "設定項目1", desc: "購入回数設定に関する設定", enabled: true },
  { name: "設定項目2", desc: "購入回数設定の自動処理", enabled: true },
  { name: "設定項目3", desc: "購入回数設定の通知", enabled: false },
];
export default function Page() {
  return (
    <div className="space-y-5">
      <h1 className="text-2xl font-bold text-gray-800">購入回数設定</h1>
      <GlassCard>
