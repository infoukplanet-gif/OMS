...
const data = [
  { col1: "サンプル1", col2: "値1", col3: "楽天スーパーロジ 処理状況一覧", col4: "2024/04/12", status: "処理済" },
  { col1: "サンプル2", col2: "値2", col3: "楽天スーパーロジ 処理状況一覧", col4: "2024/04/11", status: "処理中" },
  { col1: "サンプル3", col2: "値3", col3: "楽天スーパーロジ 処理状況一覧", col4: "2024/04/10", status: "処理済" },
];
export default function Page() {
  return (
    <div className="space-y-5">
      <h1 className="text-2xl font-bold text-gray-800">楽天スーパーロジ 処理状況一覧</h1>
