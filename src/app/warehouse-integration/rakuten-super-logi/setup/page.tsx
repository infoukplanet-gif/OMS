...
const items = [
  { name: "設定項目1", desc: "楽天スーパーロジ SKUマッピングに関する設定", enabled: true },
  { name: "設定項目2", desc: "楽天スーパーロジ SKUマッピングの自動処理", enabled: true },
  { name: "設定項目3", desc: "楽天スーパーロジ SKUマッピングの通知", enabled: false },
];
export default function Page() {
  return (
    <div className="space-y-5">
      <h1 className="text-2xl font-bold text-gray-800">楽天スーパーロジ SKUマッピング</h1>
      <GlassCard>
