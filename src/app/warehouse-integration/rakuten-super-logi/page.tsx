...
const items = [
  { name: "設定項目1", desc: "楽天スーパーロジ初期登録に関する設定", enabled: true },
  { name: "設定項目2", desc: "楽天スーパーロジ初期登録の自動処理", enabled: true },
  { name: "設定項目3", desc: "楽天スーパーロジ初期登録の通知", enabled: false },
];
export default function Page() {
  return (
    <div className="space-y-5">
      <h1 className="text-2xl font-bold text-gray-800">楽天スーパーロジ初期登録</h1>
      <GlassCard>
