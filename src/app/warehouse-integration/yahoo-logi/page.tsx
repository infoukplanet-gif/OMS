...
const items = [
  { name: "設定項目1", desc: "Yahoo!ロジスティクスに関する設定", enabled: true },
  { name: "設定項目2", desc: "Yahoo!ロジスティクスの自動処理", enabled: true },
  { name: "設定項目3", desc: "Yahoo!ロジスティクスの通知", enabled: false },
];
export default function Page() {
  return (
    <div className="space-y-5">
      <h1 className="text-2xl font-bold text-gray-800">Yahoo!ロジスティクス</h1>
      <GlassCard>
