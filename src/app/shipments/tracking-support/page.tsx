...
const data = [
  { col1: "サンプル1", col2: "値1", col3: "配送番号サポート", col4: "2024/04/12", status: "処理済" },
  { col1: "サンプル2", col2: "値2", col3: "配送番号サポート", col4: "2024/04/11", status: "処理中" },
  { col1: "サンプル3", col2: "値3", col3: "配送番号サポート", col4: "2024/04/10", status: "処理済" },
];
