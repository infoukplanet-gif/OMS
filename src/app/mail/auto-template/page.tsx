...
const items = [
  { name: "設定項目1", desc: "自動送信メールテンプレート設定に関する設定", enabled: true },
  { name: "設定項目2", desc: "自動送信メールテンプレート設定の自動処理", enabled: true },
  { name: "設定項目3", desc: "自動送信メールテンプレート設定の通知", enabled: false },
];
export default function Page() {
  return (
    <div className="space-y-5">
      <h1 className="text-2xl font-bold text-gray-800">自動送信メールテンプレート設定</h1>
      <GlassCard>
